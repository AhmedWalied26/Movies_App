...
class AppStyles {
  ...
  static TextStyle bold20DarkBlack = GoogleFonts.inter(
    fontSize: 20,
    fontWeight: FontWeight.bold,
  ...
  static TextStyle medium14Black = GoogleFonts.roboto(
    fontSize: 14,
    fontWeight: FontWeight.w500,
    color: AppColors.blackColor,
  );
  ...
  static TextStyle regular14Black = GoogleFonts.roboto(
    fontSize: 14,
  ...
  static TextStyle regular13White = GoogleFonts.roboto(
    fontSize: 13,
    fontWeight: FontWeight.w400,
    color: AppColors.whiteColor,
  );
  ...
  static TextStyle regular20WhiteOp = GoogleFonts.inter(
    fontSize: 20,
    fontWeight: FontWeight.w400,
    color: AppColors.whiteColorOP,
  );
  ...
  static TextStyle regular13Grey = GoogleFonts.roboto(
    fontSize: 13,
    fontWeight: FontWeight.w400,
    color: AppColors.lightSecondaryTextColor,
  );

  static TextStyle regular12Grey = GoogleFonts.roboto(
    fontSize: 12,
    fontWeight: FontWeight.w400,
    color: AppColors.lightSecondaryTextColor,
  );
